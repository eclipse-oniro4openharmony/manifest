...
To support global developers, Oniro mirrors the source on its own infrastructure while falling back to [Gitee](https://gitee.com/openharmony/manifest.git) as needed. Below are example commands for various scenarios:
